...
module Admin
  ...
  class OrdersController < AdminController
    ...
    def arrears
      ...
      @arrears = Order.arrears.since(30.days.ago).oldest.limit(50).includes(:user)
      @assemble_arrears = Order.assemble_arrears.since(30.days.ago).oldest.limit(50).includes(:user)
    end
